...
import org.openqa.selenium.WebDriver;
		...
		@FindBy(how=How.XPATH,using="//*[@id=\"49\"]")
		@CacheLookup
		WebElement selectsupplier;   
		
		@FindBy(how=How.XPATH,using="//*[@id=\"breweryStepSeven\"]/div[1]/div[4]/div[3]")
		@CacheLookup
		WebElement scrollone; 
		...
		WebElement submittender;
			...
			public void submit_tender() {
				submittender.click();
			}
			
			public void scroll_one() throws Exception {
				((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView();", scrollone); 
				Thread.sleep(5000);
			}
